...
const SUCCESS_TESTS: Tests = {
    'API Tests':    /\[AEG Robot\] All \d+ API tests passed/,
    'Registered':   /\[AEG Robot\] Registered [1-9]\d* robot vacuum device/,
    'Configured':   /\[AEG Robot\] Configured [1-9]\d* robot vacuum device/
};
