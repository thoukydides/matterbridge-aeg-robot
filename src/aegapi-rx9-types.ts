...
export interface RX9ApplianceCapabilities {
    ...
    robotStatus: {
        ...
        type:                           string;
        values: {
            // { [key in `${RX9RobotStatus}`]: RX9NoTriggers; }
    ...
    dustbinStatus?: {
        ...
        type:                           'string';
        values: {
            // { [key in Capitalize<RX9Dustbin>]: RX9NoTriggers; }
...
export interface RX9CapabilitySupported { [index: string]: never };
export interface RX9CapabilitiesObject {
    // { [key in RX9Capabilities]: RX9CapabilitySupported; }
    ecoMode?:                           RX9CapabilitySupported;
    powerLevels?:                       RX9CapabilitySupported;
    customPlay?:                        RX9CapabilitySupported;
    freezeMapOnDemand?:                 RX9CapabilitySupported;
    interactiveMap?:                    RX9CapabilitySupported;
    multipleScheduledCleaningsPerDay?:  RX9CapabilitySupported;
    powerZones?:                        RX9CapabilitySupported;
}
